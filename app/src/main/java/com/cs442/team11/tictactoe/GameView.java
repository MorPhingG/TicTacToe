...
public class GameView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(whowin==2){
            paint.setColor(Color.GREEN);
            paint.setStyle(Paint.Style.STROKE);
            canvas.drawLine(startX, startY, startX+9*GRID_WIDTH, startY+9*GRID_WIDTH, paint);
            canvas.drawLine(startX, startY+9*GRID_WIDTH, startX+9*GRID_WIDTH, startY, paint);
